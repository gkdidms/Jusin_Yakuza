...
HRESULT CLoader::Loading_For_Test()
{
	...
	/* For.Prototype_Component_VIBuffer_Terrain_Flat */
	if (FAILED(m_pGameInstance->Add_Component_Prototype(LEVEL_TEST, TEXT("Prototype_Component_VIBuffer_Terrain_Flat"),

	...
	:CBehaviorAnimation{}
{
	...
	m_AnimationIndex.push_back(312);	//[311]	p_mov_run_dash_tired_stop_l				/ 8
	m_AnimationIndex.push_back(313);	//[312]	p_mov_run_dash_tired_stop_s				/ 9

	// 대시 (어따쓰는진 모르겟음)
	m_AnimationIndex.push_back(310);	// p_mov_run_dash 309							/ 10
	m_AnimationIndex.push_back(311);	// p_mov_run_dash_tired 310						/ 11
	m_AnimationIndex.push_back(312);	// [312]	p_mov_run_dash_tired_stop_l			/ 12
	m_AnimationIndex.push_back(313);	// [313]	p_mov_run_dash_tired_stop_s			/ 13

	// 범프 (부딪힐때)
	
	m_AnimationIndex.push_back(294); //[293]	p_mov_bump_car_f[p_mov_bump_car_f]		 / 14
	m_AnimationIndex.push_back(295); //[294]	p_mov_bump_car_l[p_mov_bump_car_l]		 / 15
	m_AnimationIndex.push_back(296); //[295]	p_mov_bump_car_r[p_mov_bump_car_r]		 / 16
	m_AnimationIndex.push_back(297); //[296]	p_mov_bump_f[p_mov_bump_f]				 / 17
	m_AnimationIndex.push_back(298); //[297]	p_mov_bump_l[p_mov_bump_l]				 / 18
	m_AnimationIndex.push_back(299); //[298]	p_mov_bump_r[p_mov_bump_r]				 / 19
	m_AnimationIndex.push_back(300); //[299]	p_mov_bump_wall_l[p_mov_bump_wall_l]	 / 20
	m_AnimationIndex.push_back(301); //[300]	p_mov_bump_wall_r[p_mov_bump_wall_r]	 / 21


	//데미지 입은 상태일 때																 
	m_AnimationIndex.push_back(302); //[301]	p_mov_dam_lp[p_mov_dam_lp]				 / 22
	m_AnimationIndex.push_back(303); //[302]	p_mov_dam_run[p_mov_dam_run]			 / 23
	m_AnimationIndex.push_back(304); //[303]	p_mov_dam_walk[p_mov_dam_walk]			 / 24
	m_AnimationIndex.push_back(305); //[304]	p_mov_dam_walk_turnl[p_mov_dam_walk_turnl]	 / 25
	m_AnimationIndex.push_back(306); //[305]	p_mov_dam_walk_turnr[p_mov_dam_walk_turnr]	 / 26

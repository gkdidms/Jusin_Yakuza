...
void CKnife::Priority_Tick(const _float& fTimeDelta)
{
	__super::Priority_Tick(fTimeDelta);
}

void CKnife::Tick(const _float& fTimeDelta)
{
	__super::Tick(fTimeDelta);
}

void CKnife::Late_Tick(const _float& fTimeDelta)
{
...
HRESULT CKnife::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(m_iCurrentLevel, TEXT("Prototype_Component_Model_Knife"),
...
HRESULT CKnife::Bind_ResourceData()
{

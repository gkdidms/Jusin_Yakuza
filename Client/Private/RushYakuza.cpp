...
void CRushYakuza::Change_Animation()
{
	...
	case MONSTER_IDLE:
	{
		m_strAnimName = "e_pnc_stand[e_pnc_stand]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_F:
	{
		...
		m_strAnimName = "p_krh_shift_f[p_krh_shift_f]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_L:
	{
		...
		m_strAnimName = "p_krh_shift_l[p_krh_shift_l]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_R:
	{
		...
		m_strAnimName = "p_krh_shift_r[p_krh_shift_r]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_B:
	{
		...
		m_strAnimName = "p_krh_shift_b[p_krh_shift_b]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_FR:
	{
		...
		m_strAnimName = "p_krh_shift_fr[p_krh_shift_fr]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_FL:
	{
		...
		m_strAnimName = "p_krh_shift_fl[p_krh_shift_fl]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_BR:
	{
		...
		m_strAnimName = "p_krh_shift_br[p_krh_shift_br]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_SHIFT_BL:
	{
		...
		m_strAnimName = "p_krh_shift_bl[p_krh_shift_bl]";
		m_isAnimLoop = true;
		break;
	}
	case MONSTER_CMD_1:
	{
		...
		m_strAnimName = "p_krh_cmb_01[p_krh_cmb_01]";
		break;
	}
	case MONSTER_CMD_2:
	{
		//p_krh_cmb_02[p_krh_cmb_02]
		m_strAnimName = "p_krh_cmb_02[p_krh_cmb_02]";
		break;
	}
	case MONSTER_CMD_3:
	{
		//p_krh_cmb_03[p_krh_cmb_03]
		m_strAnimName = "p_krh_cmb_03[p_krh_cmb_03]";
		break;
	}
	case MONSTER_CMD_4:
	{
		//p_krh_cmb_04[p_krh_cmb_04]
		m_strAnimName = "p_krh_cmb_04[p_krh_cmb_04]";
		break;
	}
	case MONSTER_CMD_5:
	{
		//p_krh_cmb_05[p_krh_cmb_05]
		m_strAnimName = "p_krh_cmb_05[p_krh_cmb_05]";
		break;
	}
	case MONSTER_DEATH:
	{

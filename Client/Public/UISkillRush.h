...
protected:
    CUISkillRush();
    CUISkillRush(const CUISkillRush& rhs);
    virtual ~CUISkillRush() = default;
public:
...
private:
    ...
    _uint m_iPrice[6] = { 400000,3000000000,2000000,400000000 ,400000000 ,100000000 };
    _bool m_isGet = { false };
...
public:
    static CUISkillRush* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg = nullptr);
    virtual void Free();
};
END

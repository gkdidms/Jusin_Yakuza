...
PS_OUT_LUMINANCE_SUM PS_MAIN_LUMINANCE_SUM(PS_IN In) // 휘도 맵 구하기 (처음 시작)
{
...
PS_OUT_LUMINANCE_SUM PS_MAIN_LUMINANCE_SUM_LOOP(PS_IN In) // 휘도 맵 구하기 (루프)
{
    PS_OUT_LUMINANCE_SUM Out = (PS_OUT_LUMINANCE_SUM) 0;
...
PS_OUT_LUMINANCE_SUM PS_MAIN_COPYLUMINANCE(PS_IN In) // 이전 휘도를 저장
{
    PS_OUT_LUMINANCE_SUM Out = (PS_OUT_LUMINANCE_SUM) 0;
